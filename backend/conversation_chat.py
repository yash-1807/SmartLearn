...
teacher_agent = Agent(
    ...
    goal="Provide detailed, instructive responses that not only answer questions but also explain underlying concepts and strategies related to the active week's content.",
...
def chat_teacher_endpoint(request: ChatTeacherRequest):
    ...
    # Construct a detailed task description instructing the agent to teach/explain concepts
    task_description = (
        f"Active Week Content:\n{request.active_week_content}\n\n"
        f"Conversation History:\n{conversation_text}\n\n"
        f"User Message: {request.user_message}\n\n"
        "As a dedicated teacher, provide a detailed and clear explanation addressing the user's query. "
